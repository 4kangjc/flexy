...
int32_t FunctionWSServlet::onConnect(const HttpRequest::ptr& header,
...
int32_t FunctionWSServlet::onClose(const HttpRequest::ptr& header,
                                   const WSSession::ptr& session) {
    if (onClose_) {
...
int32_t FunctionWSServlet::handle(const HttpRequest::ptr& header,
